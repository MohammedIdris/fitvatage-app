...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fitvantage.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fitvantage.app.security.DomainUserDetailsService", "createSpringSecurityUser");
